...
// ---------------------------------------------------------------------------
// Four-on-the-floor pattern tool
// ---------------------------------------------------------------------------
    ...
    },
    {
        ...
        function: {
            ...
            parameters: {
                type: 'object',
                properties: {
                    file_url: { type: 'string', description: 'URL of the audio sample file' },
                    track_name: { type: 'string', description: 'Name for the new track', default: 'Kick Pattern' },
                    num_bars: { type: 'integer', description: 'Number of bars (default 4)', default: 4 },
                    position: { type: 'number', description: 'Start position in beats (default 0)', default: 0 },
                },
                required: ['file_url'],
            },
        },
